...
const getCategoryShadowStyle = (category: Article['category']): string => {
    switch (category) {
    ...
    const handleShare = async () => {
        ...
        if (sourceUri) {
            try {
                ...
                // Ensure the URL has a shareable protocol (http or https)
            ...
            >
                ...
                <div className="overflow-y-auto px-6 md:px-8">
                    <div className="space-y-4 text-gray-300">
                        <p className="font-semibold text-gray-200">{article.summary}</p>
                        <p className="whitespace-pre-wrap">{article.fullArticle}</p>
                    </div>
